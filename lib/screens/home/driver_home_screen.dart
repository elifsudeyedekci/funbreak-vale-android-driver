...
class _DriverHomeScreenState extends State<DriverHomeScreen> with TickerProviderStateMixin {
  ...
  void _showNewRidePopup(Map<String, dynamic> rideData) {
    ...
    print('🎯 [POPUP] _showNewRidePopup ÇAĞRILDI:');
  ...
  Future<void> _loadTodayStats() async {
    try {
      ...
      print('📊 Android GÜNLÜK KAZANÇ API RESPONSE:');
      ...
      if (mounted) {
        ...
        print('✅ Android günlük kazanç kartı güncellendi: ₺${_todayEarnings.toStringAsFixed(2)}');
      }
    } catch (e) {
      print('❌ Android günlük kazanç hatası: $e');
    }
  }
